...
`,Nt={shorten_cards:!1,consolidate_entities:!1,child_card:!1,hide_header:!1,show_header_icon:!1,header:"",persist_features:!1,brightness:!0,color_temp:!0,white_value:!0,warm_white_value:!0,color_picker:!0,effects_list:!0,speed:!0,intensity:!0,force_features:!1,show_slider_percent:!1,full_width_sliders:!1,color_temp_in_kelvin:!1,transition:0,brightness_icon:"weather-sunny",white_icon:"file-word-box",warm_white_icon:"weather-sunset",temperature_icon:"thermometer",speed_icon:"speedometer",intensity_icon:"transit-connection-horizontal"},Ut=o`
  .entities {
    padding-top: 10px;
    padding-bottom: 10px;
    display: flex;
...
`,It=(t,e)=>t.reduce((t,i)=>(i.defineId?t[i.defineId]=i:i.promise.then(t=>{void 0===e.registry.get(i.name)&&e.registry.define(i.name,t)}),t),{}),Rt=t=>({name:t,promise:customElements.whenDefined(t).then(()=>customElements.get(t))}),Ht=(t,e,i={},n={})=>{const r=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return r.detail=i,t.dispatchEvent(r),r};class Vt extends(Tt(Et)){static get elementDefinitions(){return It([Rt("ha-checkbox"),Rt("ha-formfield"),Rt("ha-form-string"),Rt("ha-entity-picker")],Vt)}static get styles(){return Ut}static get properties(){return{hass:{},_config:{}}}setConfig(t){this._config={...Nt,...t}}get entityDomains(){return["switch","light","group"]}firstUpdated(){this._firstRendered=!0}render(){if(!this.hass||!this._config)return X``;let{header:t}=this._config;if(!t&&this._config.entity){let e=this._config.entity.split(".")[1]||"";e&&(e=e.charAt(0).toUpperCase()+e.slice(1),t=e)}return X`
    ...
    `}createHeader(t){if(this.config.hide_header)return X``;const e=((t,e,i)=>"string"==typeof i&&i?i:e?(t=>{if(!t||"function"!=typeof t.formatEntityName)return!1;const e=t.config&&t.config.version||"",[i,n]=e.split(".",2);return Number(i)>2026||2026===Number(i)&&Number(n)>=4})(t)?t.formatEntityName(e,i):e.attributes&&e.attributes.friendly_name:void 0)(this.hass,t,this.config.header)||t.entity_id;return X`
